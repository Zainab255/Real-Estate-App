...
const OurServices = () => {
  return (
    ...
    <h2 className="text-4xl font-bold text-gray-800 mb-6">Our  <span className="text-blue-800">Services</span></h2>
            ...
            <div className="w-full md:w-1/3 px-4 mb-8">
              <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                ...
                <div className="p-4">
                  ...
                  <button className="mt-6 px-4 py-2 bg-blue-900 text-white rounded-md hover:bg-blue-700">
                  Learn More
                </button>
                </div>
              </div>
