...
import Imagee from "../../assets/12.png";
import Imageee from "../../assets/11.png";
import Imageeee from "../../assets/10.png";

const Features = () => {
  return (
    <div id="feature" className="w-full min-h-screen p-2 flex items-center bg-gradient-to-b from-white to-gray-400">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
      <h2 className="text-4xl font-bold text-gray-800 mb-6">Feature <span className="text-blue-800">Properties</span></h2>
