...
import PropertyImage1 from "../../assets/9.png";
import PropertyImage2 from "../../assets/2.png";
import PropertyImage3 from "../../assets/5.png";

const SaleProperties = () => {
  return (
    <div id="sale" className="w-full min-h-screen p-2 flex items-center bg-gray-100">
    <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
    <h2 className="text-4xl font-bold text-gray-800 mb-6">On Sale  <span className="text-blue-800">Properties</span></h2>
        ...
        <div className="hover:shadow-md hover:shadow-[#040c16]">
          <div className="bg-white rounded-lg shadow-lg">
            ...
            <div className="py-6 px-4">
              ...
              <button className="mt-6 px-4 py-2 bg-blue-900 text-white rounded-md hover:bg-blue-800">
                View Details
              </button>
            </div>
          </div>
